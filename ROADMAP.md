...
- **Group D's four-phase plan and the inheritance follow-up are fully shipped.** No open items remain from either; what remains of Group D is items 3–4 of the list (per-layer coloring beyond the per-sheet stores already built, and color as an animatable timeline parameter).
